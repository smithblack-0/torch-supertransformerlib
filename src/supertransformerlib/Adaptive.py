...
class AdaptiveAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self.attn_query_projector = src.supertransformerlib.Basics.Basics._Linear(d_query, [heads, d_head], parallelization)
        self.attn_key_projector = src.supertransformerlib.Basics.Basics._Linear(d_key, [heads, d_head], parallelization)

        # Confidence projectors

        self.confidence_query_projector = src.supertransformerlib.Basics.Basics._Linear(d_query, [heads, d_confidence], parallelization)
        self.confidence_key_projector = src.supertransformerlib.Basics.Basics._Linear(d_key, [heads, d_confidence], parallelization)

        # Assembly projectors

        self.assembly_query_projector = src.supertransformerlib.Basics.Basics._Linear(d_query, [heads, d_assembly], parallelization)
        self.assembly_key_projector = src.supertransformerlib.Basics.Basics._Linear(d_key, [heads, d_assembly], parallelization)

        # Value and deheading projectors.

        self.value_projection = src.supertransformerlib.Basics.Basics._Linear(d_value, [heads, d_head], parallelization)
        self.dehead = src.supertransformerlib.Basics.Basics._Linear([heads, d_head], d_value, parallelization)
